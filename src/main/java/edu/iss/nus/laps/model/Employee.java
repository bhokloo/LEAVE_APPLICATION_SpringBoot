...
public class Employee {
	...
	public Employee(@NotBlank(message = "Name may not be empty") String empid, String empname, String emppassword,
			@Future LocalDate startDate, @Future LocalDate endDate, String leaveType, String status, String reason,
			String managerComment, int annualLeave, int medicalLeave, int noOfLeave, int weekends, int publicholidays,
			String newdate, String radio, Manager managerfk) {
		super();
		this.empid = empid;
		this.empname = empname;
		this.emppassword = emppassword;
